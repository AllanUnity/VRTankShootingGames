...
namespace AssetBundles
{
    ...
    public class AssetBundleManager : MonoBehaviour
    {
        ...
        /// </summary>
        public void LoadAssetAsync<TAsset>(string assetBundleName, string assetName, Action<TAsset> onLoad) where TAsset : UnityEngine.Object
        {
            StartCoroutine(LoadAssetAsyncRoutine(assetBundleName, assetName, onLoad));
        }
        ...
        IEnumerator LoadAssetAsyncRoutine<TAsset>(string assetBundleName, string assetName, Action<TAsset> onLoad) where TAsset : UnityEngine.Object
        {
            AssetBundleLoadAssetOperation loadAsset = LoadAssetAsync<TAsset>(assetBundleName, assetName);
